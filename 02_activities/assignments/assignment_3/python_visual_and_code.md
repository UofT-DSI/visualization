Visual: 
![python visualization](./python_visualization.png)

Information about the visual:
This plot shows the Crime Severity Index in Canadian Cities in 2012.

Code: 
The code can also be found in `02_activities\assignments\assignment_3\visual1.ipynb`
